...
export const ButtonRotatingBackgroundGradient = () => {
  return (
    ...
    <button className='relative inline-flex h-12 overflow-hidden rounded-full p-px focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50'>
      ...
      <span className='inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-gray-950 lg:px-8 px-3 lg:py-1 text-sm font-medium text-gray-50 backdrop-blur-3xl'>
        Get Started
      </span>
    </button>
    </Link>
