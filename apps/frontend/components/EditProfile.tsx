...
export const EditProfile = (props: any) => {
  ...
  return (<div>
    {/* <button onClick={Edit} className='flex gap-1 p-2 cursor-pointer rounded-lg font-medium bg-gray-800 hover:bg-gray-600 text-black items-center'><div className=' text-white'><Image src={edit} alt='Edit' width={15} height={15}></Image>{props.title}</div></button>*/}
